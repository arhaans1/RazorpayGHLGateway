...
<script>
  (async () => {
    ...
    try {
      ...
      if (!name || !email || !phone) {
        alert('Missing required information. Please ensure name, email, and phone are provided in the URL parameters.\\n\\nExample: ?name=John&email=john@example.com&phone=9876543210');
        return;
      }
